...
class YOLO:
    ...
    Attributes:
        ...
        metrics (Any): The res_data for metrics.
    ...
    def train(self, **kwargs):
        ...
        if not overrides.get('res_data'):
            raise AttributeError("Dataset required but missing, i.e. pass 'res_data=coco128.yaml'")
    ...
    def _reset_ckpt_args(args):
        ...
        include = {'imgsz', 'res_data', 'task', 'single_cls'}  # only remember these arguments when loading a PyTorch model
