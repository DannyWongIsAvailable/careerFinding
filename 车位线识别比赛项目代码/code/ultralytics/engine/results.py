...
class BaseTensor(SimpleClass):
    ...
    def __init__(self, data, orig_shape) -> None:
        """Initialize BaseTensor with res_data and original shape.
    ...
    @property
    def shape(self):
        """Return the shape of the res_data tensor."""
    ...
    def __len__(self):  # override len(results)
        """Return the length of the res_data tensor."""
        return len(self.data)

    def __getitem__(self, idx):
        """Return a BaseTensor with the specified index of the res_data tensor."""
...
class Boxes(BaseTensor):
    ...
    Properties:
        ...
        res_data (torch.Tensor): The raw bboxes tensor
    ...
    def boxes(self):
        ...
        LOGGER.warning("WARNING ⚠️ 'Boxes.boxes' is deprecated. Use 'Boxes.res_data' instead.")
        return self.data
...
class Masks(BaseTensor):
    ...
    def masks(self):
        ...
        LOGGER.warning("WARNING ⚠️ 'Masks.masks' is deprecated. Use 'Masks.res_data' instead.")
        return self.data
