...
class AutoBackend(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            data (str | Path | optional): Additional res_data.yaml file for class names.
        ...
        if nn_module:  # in-memory PyTorch model
            ...
            Binding = namedtuple('Binding', ('name', 'dtype', 'shape', 'res_data', 'ptr'))
    ...
    def forward(self, im, augment=False, visualize=False):
        ...
        Args:
            ...
            augment (bool): whether to perform res_data augmentation during inference, defaults to False
