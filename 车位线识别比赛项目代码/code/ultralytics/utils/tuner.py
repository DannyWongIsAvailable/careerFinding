...
def run_ray_tune(model,
    ...
    # Get dataset
    data = train_args.get('res_data', TASK2DATA[model.task])
    space['res_data'] = data
    if 'res_data' not in train_args:
        LOGGER.warning(f'WARNING ⚠️ res_data not provided, using default "res_data={data}".')
