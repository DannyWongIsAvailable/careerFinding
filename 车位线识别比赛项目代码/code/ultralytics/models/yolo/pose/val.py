...
class PoseValidator(DetectionValidator):
    ...
    def preprocess(self, batch):
        """Preprocesses the batch by converting the 'keypoints' res_data into a float and moving it to the device."""
...
def val(cfg=DEFAULT_CFG, use_python=False):
    """Performs validation on YOLO model using given res_data."""
