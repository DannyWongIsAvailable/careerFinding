...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir='', names=(), on_plot=None):
        ...
        Args:
            ...
            on_plot (func): An optional callback to pass plots path and res_data when they are rendered.
        """
...
def ap_per_class(tp,
    ...
    Args:
        ...
        on_plot (func, optional): A callback to pass plots path and res_data when they are rendered. Defaults to None.
    ...
    Returns:
        (tuple): A tuple of six arrays and one array of unique classes, where:
            ...
            unique_classes (np.ndarray): An array of unique classes that have res_data.
    ...
    f1 = 2 * p * r / (p + r + eps)
    names = [v for k, v in names.items() if k in unique_classes]  # list: only classes that have res_data
...
class DetMetrics(SimpleClass):
    ...
    Args:
        ...
        on_plot (func): An optional callback to pass plots path and res_data when they are rendered. Defaults to None.
